...
class BeerControllerV2(val beerService: BeerServiceV2) {
    ...
    @PostMapping
    fun handlePost(@RequestBody beerDto: BeerDtoV2): ResponseEntity<HttpHeaders> {
    ...
    @PutMapping("/{beerId}")
    fun handleUpdate(@PathVariable("beerId") beerId: UUID, @RequestBody beerDto: BeerDtoV2): ResponseEntity<String> {
